...
export default function DiscountSection() {
    const Products = [
        {image: "/assets/images/products/Iphone 14 pro 3.png", alt: "Apple iPhone 14 Pro 512GB Gold", label: "Apple iPhone 14 Pro 512GB Gold", description: "(MQ233)", price: "$1437"},
        ...
        {image: "/assets/images/products/Iphone 14 pro 2.png", alt: "Apple iPhone 14 Pro 1TB Gold", label: "Apple iPhone 14 Pro 1TB Gold", description: "(MQ2V3)", price: "$1499"},
    ]
    ...
    return (
        <div className="bg-white min-w-full py-20">
            <div className='container mx-auto px-4 md:px-20 lg:max-w-[1000px] 2xl:max-w-[1300px]'>
                ...
                <div className='grid grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 gap-4 mt-10'>
